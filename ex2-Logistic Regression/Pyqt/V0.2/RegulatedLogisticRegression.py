...
def find_decision_boundary(density, power, theta, threshhold):
    ...
    xx, yy = np.meshgrid(t1, t2)  # 生成网格数据

    # 生成高维特征数据并求出z
    z = feature_mapping(xx.ravel(), yy.ravel(), 6, as_ndarray=True) @ theta
    ...
    return decision.f10, decision.f01, xx, yy, z
